...
<body id="bodyId">
	...
	<form method="POST" action="">		
		<div style="padding-left: 15vh; padding-right: 10vh; color: white; text-align: center;"><h3>Forgot username or password?</h3><br>To reset your username or password, please enter the email associated with your account.
		</div>
		<div id="tableId">
