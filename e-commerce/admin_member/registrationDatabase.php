...
//--------------------------------------------------------------------------------------------------------------------------------
	...
	$stmt = $conn->prepare("INSERT INTO registrationTable (fullName, eMail, password, activationCode) VALUES (?, ?, ?, ?)");
	...
	$stmt->bind_param("ssss", $fName, $eMail, $password, $verCode_hash); //Binding parameters into prepared statement
