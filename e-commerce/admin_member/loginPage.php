...
<body id="bodyId">
	...
	<form method="POST" action=""><!--action="" refers to the self submission of this form-->
		...
		<div id="tableId">
			...
			<div id="td1">Email:
				<div id="td2">
					<input id="inputId" style="height: 50px;" type="text" name="eMail" value="<?php echo $eMail; ?>" required autofocus/><!--eMail input area-->
				</div>
			</div><br>
		
			<div id="td1">Password:
				<div id="td2">
					<input id="inputId" style="height: 50px;" type="password" name="password" required/><!--Password input area-->
				</div>
			</div><br>
			...
			<div id="td1">Enter captcha:
				<div id="td2">
					<input id="inputId" style="height: 50px;" type="text" name="vercode" required/>
		...
		<footer id="footerId">Don't have an account? Register <a href="registrationPage.php"><strong>here</strong></a>
			&nbsp;
			<a href="registrationPage.php">Back</a>
		</footer><!--Link to the registration page-->
		<br><br><br>
	</form>
</body>
</html>
